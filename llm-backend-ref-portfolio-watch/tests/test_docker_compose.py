"""Phase 7 — docker-compose.yml: AI + Backend + Frontend, port, SQLite volume."""
...
def test_docker_compose_has_app_port_and_sqlite_volume():
    ...
    assert "8001:8001" in text or '"8001:8001"' in text
    assert "8000:8000" in text or '"8000:8000"' in text or "APP_HOST_PORT" in text
    assert "5173:5173" in text or '"5173:5173"' in text
