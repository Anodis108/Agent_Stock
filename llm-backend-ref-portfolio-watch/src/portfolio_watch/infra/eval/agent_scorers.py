...
from src.portfolio_watch.infra.llm.completion import chat_parsed
...
_TASK_SUCCESS_SYSTEM = """Bạn là giám khảo đánh giá trợ lý hỏi–đáp cổ phiếu Việt Nam
(Portfolio Watch).
...
_TRAJECTORY_SYSTEM = """Bạn chấm CHUỖI HÀNH ĐỘNG của multi-agent Portfolio Watch
