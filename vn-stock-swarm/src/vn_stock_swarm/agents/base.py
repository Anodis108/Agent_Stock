...
from vn_stock_swarm import handoff, membership, metrics
from vn_stock_swarm.config import Settings, get_settings
from vn_stock_swarm.dedup import claim_url
from vn_stock_swarm.fetcher import RawResponse, fetch_page
from vn_stock_swarm.hashing import am_i_owner
from vn_stock_swarm.logging_config import get_logger
from vn_stock_swarm.pre_route import stream_name
from vn_stock_swarm.rate_limiter import DomainRateLimiter
from vn_stock_swarm.redis_client import get_redis
from vn_stock_swarm.robots import RobotsCache
from vn_stock_swarm.router import ContentRouter, RouteResult
from vn_stock_swarm.sink_router import SinkRouter
from vn_stock_swarm.sink_store import SinkStore
from vn_stock_swarm.storage import ResultStore
...
class BaseCrawlerAgent:
    ...
    def _guess_link_agent_type(self, link: str) -> str:
        from vn_stock_swarm.pre_route import guess_agent_type
